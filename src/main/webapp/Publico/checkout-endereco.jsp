                    ...
                    <input class="form-check-input" type="radio" name="enderecoEscolhido" id="enderecoEscolhido" value="${endereco.idEndereco}" required>
                        ...
                        <c:if test="${empty listaCheckout}">
                            ...
                            <div class="form-group form-check-inline">
                                                  <input class="form-check-input" type="radio" name="frete" id="Frete01" value="44.36"  onClick="attSubTotal('<%= subTotal-15.44 %>',44.36)" required>
                                        ...
                                        <div class="form-group form-check-inline">
                                                  <input class="form-check-input" type="radio" name="frete" id="Frete02" value="15.44" checked onClick="attSubTotal('<%= subTotal-15.44 %>',15.44)" required>
                                        ...
                                        <div class="form-group form-check-inline">
                                                    <input class="form-check-input" type="radio" name="frete" id="Frete03" value="10.90"  onClick="attSubTotal('<%= subTotal-15.44 %>',10.90)" required>
                        ...
                        <div class="col-sm">
                            ...
                            <c:when test="${checkout.frete==44.36}">
                                        ...
                                        <div class="form-group form-check-inline">
                                                  <input class="form-check-input" type="radio" name="frete" id="Frete01" value="44.36" checked onClick="attSubTotal('<%= subTotal-15.44 %>',44.36)" required>
                                                  <label class="form-check-label" for="Frete01">
                                                      <b>R$ 44,36 Entrega Expressa</b> - Receba amanhã
                                                  </label>
                                        </div>
                                        ...
                                        <div class="form-group form-check-inline">
                                                  <input class="form-check-input" type="radio" name="frete" id="Frete02" value="15.44"  onClick="attSubTotal('<%= subTotal-15.44 %>',15.44)" required>
                                                  <label class="form-check-label" for="Frete02">
                                                      <b>R$ 15,44 Entrega padrão</b>     - 5 dias úteis
                                                  </label>
                                        </div>
                            ...
                            <c:when test="${checkout.frete==10.90}">
                                ...
                                <div class="form-group form-check-inline">
                                        ...
                                        <div class="form-group form-check-inline">
                                                    <input class="form-check-input" type="radio" name="frete" id="Frete03" value="10.90" checked onClick="attSubTotal('<%= subTotal-15.44 %>',10.90)" required>
                                                    <label class="form-check-label" for="Frete03">
                                                        <b>R$ 10,90 Entrega sedex</b> - 10 dias úteis
                                                    </label>
                                        </div>
                                    ...
                                    <center><span><b>Sub-total: R$</b></span><legend id="subTotal"><%= subTotal %></legend></center>
