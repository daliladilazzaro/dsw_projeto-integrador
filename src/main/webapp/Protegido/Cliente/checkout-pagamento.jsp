            ...
            <fieldset class="border p-3 fieldset mb-25 col py-3 px-md-5 border" id="grad">
                ...
                <div class="row">
                            <div class="col-sm">
                                            ...
                                            <input class="form-control form-control-lg" name="nome" type="text" id="nome" value="" maxlength="70"><br>
                            </div>
                            <div class="col-sm">
                                <label for="colFormLabelLg" class="form-label h4">* Número: </label>
                                <input class="form-control form-control-lg" id="numero" type="text" name="numero"><br>
                            </div>
                </div>
                ...
                <div class="row">
                            ...
                            <div class="col-sm">
                                ...
                                <input class="form-control form-control-lg" id="CVV" type="number" name="CVV" max="999" min ="000" minLength="3"><br>
                            </div>
                    
                            <div class="col-sm">
                                <label for="colFormLabelLg" class="form-label h4">* Data de expiração: </label>
                                <input class="form-control form-control-lg" id="expiracao" type="date" name="expiracao"><br>
                            </div>
                </div>
